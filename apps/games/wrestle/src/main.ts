    ...
    <div class="launch-rows">
      <div class="launch-row">
        ...
        <div class="launch-row-value">
          <span class="launch-chip">Duel local</span>
        </div>
      </div>
      <div class="launch-row">
        <span class="launch-row-label">Joueurs</span>
        <div class="launch-row-value">
          <span class="launch-chip">2</span>
        </div>
      </div>
      <div class="launch-row">
        <span class="launch-row-label">Objectif</span>
        <div class="launch-row-value">
          <span class="launch-chip">Tête au sol</span>
        </div>
      </div>
    </div>
  `;
    ...
    <div class="launch-card">
      <div class="launch-head">
        <div class="launch-brand">
          ...
          <span class="launch-badge ghost">${config?.uiText.title || "Rope Wrestle"}</span>
        </div>
      ...
      <div class="launch-grid">
        <section class="launch-section">
          ...
          <p class="launch-note">Les catcheurs sont liés par les mains. Saute pour donner l'élan et faire toucher la tête adverse.</p>
        </section>
        <section class="launch-section">
