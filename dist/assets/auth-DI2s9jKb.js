import{w as r,g as v}from"./index-Cmf_HX6D.js";import{s as g,g as b,c as l,a as h}from"./cloud-CNy5s4e6.js";const f=document.getElementById("app");let e=b();g(t=>{e=t,m()});function u(t,a="info"){const s=document.createElement("div");s.className=`toast ${a}`,s.textContent=t,document.body.appendChild(s),requestAnimationFrame(()=>s.classList.add("visible")),setTimeout(()=>{s.classList.remove("visible"),setTimeout(()=>s.remove(),240)},2400)}function p(t){var o;if(!t)return"connecté";const a=(o=t.user_metadata)==null?void 0:o.identifier,s=t.email;return a||(s!=null&&s.endsWith("@user.local")?s.replace("@user.local",""):s||"connecté")}function m(){const t=r("/apps/profil/"),a=r("/"),s=e.user?`Connecté : ${p(e.user)}`:e.ready?"Connexion requise":"Supabase non configuré (.env)";f.innerHTML=`
    <div class="page">
      <header class="hero">
        <div>
  ...
  `,y()}function y(){const t=document.getElementById("cloud-login"),a=document.getElementById("cloud-register"),s=document.getElementById("cloud-logout"),o=document.getElementById("cloud-sync");t==null||t.addEventListener("click",async()=>{var c,d;const i=((c=document.getElementById("cloud-identifier"))==null?void 0:c.value)||"",n=((d=document.getElementById("cloud-password"))==null?void 0:d.value)||"";await l("login",{identifier:i,password:n})}),a==null||a.addEventListener("click",async()=>{var c,d;const i=((c=document.getElementById("cloud-identifier"))==null?void 0:c.value)||"",n=((d=document.getElementById("cloud-password"))==null?void 0:d.value)||"";await l("register",{identifier:i,password:n})}),s==null||s.addEventListener("click",async()=>{await l("logout"),u("Déconnecté du cloud","info")}),o==null||o.addEventListener("click",async()=>{const i=v(),n=await h(i.save);u(n?"Sauvegarde envoyée":e.error||"Erreur cloud",n?"success":"error")})}m();
