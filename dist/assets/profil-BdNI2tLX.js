      ...
      <div class="sections">
        <div class="grid-two">
          ...
          <section class="card">
            ...
            ${a!=null&&a.user?`<div class="status ok">Connecté : ${N(a.user)}</div>
                   <div class="actions stretch">
