import{a as oe,b as ie,d as ce,e as de,g as V,f as ue,o as pe,w as Q,u as _,c as ve,h as me,r as ge,i as fe,j as Z,A as he}from"./index-DUQ7dej_.js";import{s as be,g as ye,c as N,u as $e,r as Pe,a as Ee,l as Se,b as Ae}from"./cloud-CdY9yCw-.js";const F=document.getElementById("app"),$=oe(),M=ie(),ee=ce(),z=de();let E="hub",p=V(),K=p.save.globalLevel,o=ye(),G="",k="all",U=!1,S=null,O=null,A=!1;function te(){var n;const e=o.user;if(!e)return"connecté";const t=(n=e.user_metadata)==null?void 0:n.identifier,s=e.email;return t||(s!=null&&s.endsWith("@user.local")?s.replace("@user.local",""):s||"connecté")}function se(e){return e?"Image stockée sur Supabase. L'emoji reste disponible en secours.":o.ready?o.user?"Choisis une image, elle sera envoyée sur Supabase.":"Connecte-toi au cloud pour utiliser une image. Emoji disponible hors-ligne.":"Supabase non configuré (.env)."}ue();ne(ae($.hubTheme));be(e=>{o=e,L()});pe("ACHIEVEMENT_UNLOCKED",e=>{var n;const t=(n=e.payload)==null?void 0:n.achievementId,s=M.achievements.find(r=>r.id===t);s&&f(`Succès débloqué : ${s.title}`,"success"),t===he.achievementId&&L()});function ae(e){return e?z.find(t=>t.id===e):z[0]}function ne(e){if(!e)return;const t=document.documentElement.style;t.setProperty("--color-primary",e.colors.primary),t.setProperty("--color-secondary",e.colors.secondary),t.setProperty("--color-accent",e.colors.accent),t.setProperty("--color-bg",e.colors.background),t.setProperty("--color-surface",e.colors.surface),t.setProperty("--color-text",e.colors.text),t.setProperty("--color-muted",e.colors.muted),e.gradient&&t.setProperty("--hero-gradient",e.gradient)}function f(e,t="info"){const s=document.createElement("div");s.className=`toast ${t}`,s.textContent=e,document.body.appendChild(s),requestAnimationFrame(()=>s.classList.add("visible")),setTimeout(()=>{s.classList.remove("visible"),setTimeout(()=>s.remove(),300)},2600)}function q(e){return e?new Date(e).toLocaleString("fr-FR",{dateStyle:"medium",timeStyle:"short"}):"Jamais"}function B(e){if(!e)return"0m";const t=Math.floor(e/1e3),s=Math.floor(t/3600),n=Math.floor(t%3600/60),r=t%60;return s?`${s}h ${n}m`:n?`${n}m ${r}s`:`${r}s`}function D(e){const t=Object.entries(e.games||{});if(!t.length)return{title:"Aucun jeu",duration:"0m"};const[s,n]=t.sort((l,h)=>(h[1].timePlayedMs||0)-(l[1].timePlayedMs||0))[0],r=$.games.find(l=>l.id===s);return{title:(r==null?void 0:r.title)||s,duration:B(n.timePlayedMs)}}function le(e,t){return e||Ae(t)||null}function we(e,t,s){const n=(t||"🎮").slice(0,4),r=le(e,s);return`<div class="avatar ${r?"has-image":""}">${r?`<img src="${r}" alt="Avatar" />`:n}</div>`}function re(){if(A)return null;const e=le(p.save.playerProfile.avatarUrl,p.save.playerProfile.avatarStoragePath);return O||e}function C(){O&&(URL.revokeObjectURL(O),O=null)}function H(){const e=document.getElementById("profile-avatar-preview"),t=document.getElementById("profile-avatar-helper"),s=document.getElementById("profile-avatar-clear"),n=re(),r=p.save.playerProfile.avatar||"🎮",l=!!n;e&&(e.classList.toggle("has-image",l),e.innerHTML=l?`<img src="${n}" alt="Avatar" />`:r),t&&(t.textContent=se(l)),s&&(s.disabled=!l)}function W(e,t){const s=e.trim()||"Joueur",n=t.trim()||"🎮",r=o.user?p.save.playerProfile.name:s;_(l=>{l.playerProfile.name=r.slice(0,18),l.playerProfile.avatar=n.slice(0,4),l.playerProfile.avatarType=l.playerProfile.avatarUrl?"image":"emoji"}),L()}function xe(){const e=me(),t=new Blob([e],{type:"application/json"}),s=URL.createObjectURL(t),n=document.createElement("a");n.href=s,n.download="nintendo-hub-save.json",n.click(),URL.revokeObjectURL(s),f("Sauvegarde exportée","success")}function Le(e){const t=Z(e);t.success?(f("Import réussi","success"),C(),S=null,A=!1,L()):f(t.error||"Import impossible","error")}function Y(e){e?(ge(e),f(`Progression de ${e} réinitialisée`,"info")):(fe(),f("Progression globale réinitialisée","info")),C(),S=null,A=!1,L()}function je(e){_(t=>{const s=new Set(t.favorites||[]);s.has(e)?s.delete(e):s.add(e),t.favorites=Array.from(s)}),L()}async function Ie(){const e=V();await Ee(e.save)?(p=e,f("Sauvegarde envoyée sur le cloud","success")):o.error&&f(o.error,"error")}async function ke(){const e=await Se();e!=null&&e.state?(Z(JSON.stringify(e.state)),f("Sauvegarde cloud importée","success"),C(),S=null,A=!1,L()):e!=null&&e.error&&f(e.error,"error")}function Ce(){return`
    <nav class="nav">
  ...
  `}function Ue(){var a;const e=p.save,t=e.achievementsUnlocked.length,s=M.achievements.length,n=e.globalLevel>K,r=`--progress:${p.levelProgress*100}%`,l=B(e.globalStats.timePlayedMs),h=e.globalStats.totalSessions,b=e.playerProfile.lastPlayedGameId&&((a=$.games.find(y=>y.id===e.playerProfile.lastPlayedGameId))==null?void 0:a.title);K=e.globalLevel;const m=D(e),c=o.user?`<span class="chip success">Cloud : ${te()}</span>`:o.ready?'<span class="chip ghost">Mode invité · données locales</span>':'<span class="chip warning">Supabase non configuré (.env)</span>';return`
    <header class="card hero">
      <div class="hero-glow"></div>
      <div class="hero-top">
        <div class="profile">
          ${we(e.playerProfile.avatarUrl,e.playerProfile.avatar,e.playerProfile.avatarStoragePath)}
          <div>
            <p class="eyebrow">Arcade Galaxy</p>
  ...
  `}function Re(){const e=new Set(p.save.achievementsUnlocked),t=M.achievements.map(s=>`
        <article class="card achievement ${e.has(s.id)?"unlocked":""}">
          <div class="pill accent">${s.icon||"⭐️"}</div>
          <div>
            <h3>${s.title}</h3>
            <p>${s.description}</p>
            <p class="muted">${Je(s)}</p>
          </div>
  ...
  `}function Oe(){var b;const e=p.save,t=Object.entries(e.games||{}),s=D(e),n=o.lastSyncedAt?q(o.lastSyncedAt):"Jamais",r=e.playerProfile.lastPlayedGameId&&((b=$.games.find(m=>m.id===e.playerProfile.lastPlayedGameId))==null?void 0:b.title),l=re(),h=se(!!l);return`
    <section class="card">
      <div class="section-head">
        <div>
  ...
  `}function x(){if(!o.user){F.innerHTML=Te(),Ge();return}F.innerHTML=`
    <div class="layout">
      ${Ce()}
      ${Ue()}
      ${E==="hub"?Me():""}
  ...
  `,qe()}function Ge(){const e=document.getElementById("gate-login"),t=document.getElementById("gate-register");e==null||e.addEventListener("click",async()=>{var r,l;const s=((r=document.getElementById("gate-identifier"))==null?void 0:r.value)||"",n=((l=document.getElementById("gate-password"))==null?void 0:l.value)||"";await N("login",{identifier:s,password:n})}),t==null||t.addEventListener("click",async()=>{var r,l;const s=((r=document.getElementById("gate-identifier"))==null?void 0:r.value)||"",n=((l=document.getElementById("gate-password"))==null?void 0:l.value)||"";await N("register",{identifier:s,password:n})})}function qe(){document.querySelectorAll(".nav-btn").forEach(i=>{i.addEventListener("click",()=>{E=i.dataset.tab,x()})});const e=document.getElementById("open-profile");e==null||e.addEventListener("click",()=>{E="profile",x()});const t=document.getElementById("player-name"),s=document.getElementById("player-avatar");t&&s&&E!=="profile"&&(t.addEventListener("change",()=>W(t.value,(s==null?void 0:s.value)||"🎮")),s.addEventListener("change",()=>W((t==null?void 0:t.value)||"Joueur",s.value))),document.querySelectorAll(".help-btn").forEach(i=>{i.addEventListener("click",()=>{const v=i.dataset.help,u=ee.find(g=>g.id===v);u&&f(u.uiText.help,"info")})}),document.querySelectorAll(".favorite-btn").forEach(i=>{i.addEventListener("click",()=>{const v=i.dataset.game;v&&je(v)})});const n=document.getElementById("export-save");n==null||n.addEventListener("click",xe);const r=document.getElementById("reset-save");r==null||r.addEventListener("click",()=>Y()),document.querySelectorAll(".reset-game").forEach(i=>{i.addEventListener("click",()=>{const v=i.dataset.game;Y(v)})});const l=document.getElementById("import-btn"),h=document.getElementById("import-text");l==null||l.addEventListener("click",()=>h&&Le(h.value));const b=document.getElementById("cloud-login"),m=document.getElementById("cloud-register"),c=document.getElementById("cloud-logout"),a=document.getElementById("cloud-save"),y=document.getElementById("cloud-load");b==null||b.addEventListener("click",async()=>{var u,g;const i=((u=document.getElementById("cloud-identifier"))==null?void 0:u.value)||"",v=((g=document.getElementById("cloud-password"))==null?void 0:g.value)||"";await N("login",{identifier:i,password:v})}),m==null||m.addEventListener("click",async()=>{var u,g;const i=((u=document.getElementById("cloud-identifier"))==null?void 0:u.value)||"",v=((g=document.getElementById("cloud-password"))==null?void 0:g.value)||"";await N("register",{identifier:i,password:v})}),c==null||c.addEventListener("click",async()=>{await N("logout"),S=null,A=!1,C()}),a==null||a.addEventListener("click",Ie),y==null||y.addEventListener("click",ke);const d=document.getElementById("profile-avatar-upload"),w=document.getElementById("profile-avatar-clear"),j=document.getElementById("profile-save");d==null||d.addEventListener("change",i=>{var g;const v=i.target,u=(g=v.files)==null?void 0:g[0];if(u){if(!u.type.startsWith("image/")){f("Seules les images sont autorisées.","error"),v.value="";return}if(u.size>1.5*1024*1024){f("Image trop lourde (1.5 Mo max).","error"),v.value="";return}C(),S=u,O=URL.createObjectURL(u),A=!1,H()}}),w==null||w.addEventListener("click",()=>{A=!0,S=null,C(),H()}),j==null||j.addEventListener("click",async()=>{const i=document.getElementById("player-avatar"),v=((i==null?void 0:i.value)||"🎮").slice(0,4),u=p.save.playerProfile.avatarStoragePath;let g=p.save.playerProfile.avatarUrl,X=u;if(S){const P=await $e(S,u||void 0);if(!P.url||!P.path||P.error){f(P.error||"Upload avatar impossible","error");return}g=P.url,X=P.path}else A&&(g=void 0,X=void 0,u&&o.ready&&o.user&&await Pe(u));_(P=>{P.playerProfile.avatar=v,P.playerProfile.avatarUrl=g,P.playerProfile.avatarStoragePath=X,P.playerProfile.avatarType=g?"image":"emoji"}),S=null,A=!1,C(),f("Profil mis à jour","success"),L()});const T=document.getElementById("search-games"),R=document.getElementById("filter-fav"),J=Array.from(document.querySelectorAll(".chip-btn[data-category]")),I=document.getElementById("clear-filters");T==null||T.addEventListener("input",()=>{G=T.value,x()}),J.forEach(i=>{i.addEventListener("click",()=>{k=i.dataset.category||"all",x()})}),R==null||R.addEventListener("click",()=>{U=!U,x()}),I==null||I.addEventListener("click",()=>{G="",k="all",U=!1,x()}),H()}function L(){p=V(),ne(ae($.hubTheme)),x()}x();
