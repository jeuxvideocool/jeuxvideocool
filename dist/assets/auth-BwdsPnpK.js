import{w as r,g as v}from"./index-Bc-Kp7-P.js";import{s as g,g as b,c as l,a as h}from"./cloud-DWN9NUvT.js";const f=document.getElementById("app");let e=b();g(t=>{e=t,m()});function u(t,a="info"){const s=document.createElement("div");s.className=`toast ${a}`,s.textContent=t,document.body.appendChild(s),requestAnimationFrame(()=>s.classList.add("visible")),setTimeout(()=>{s.classList.remove("visible"),setTimeout(()=>s.remove(),240)},2400)}function p(t){var o;if(!t)return"connecté";const a=(o=t.user_metadata)==null?void 0:o.identifier,s=t.email;return a||(s!=null&&s.endsWith("@user.local")?s.replace("@user.local",""):s||"connecté")}function m(){const t=r("/apps/profil/"),a=r("/"),s=e.user?`Connecté : ${p(e.user)}`:e.ready?"Connexion requise":"Supabase non configuré (.env)";f.innerHTML=`
    <div class="page">
      <header class="hero">
        <div>
