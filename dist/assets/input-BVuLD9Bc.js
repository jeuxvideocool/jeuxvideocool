import{x as W}from"./index-DY_I_5aW.js";function Z(){const o=new Set,l=new Set(["ArrowUp","ArrowDown","ArrowLeft","ArrowRight","Space"]),t=e=>{l.has(e.code)&&e.preventDefault(),o.add(e.code)},s=e=>{l.has(e.code)&&e.preventDefault(),o.delete(e.code)};return window.addEventListener("keydown",t),window.addEventListener("keyup",s),{isDown:e=>o.has(e),dispose(){window.removeEventListener("keydown",t),window.removeEventListener("keyup",s),o.clear()}}}function te(){const o=Z(),l=new Set,t=(e,a)=>{e&&(a?l.add(e):l.delete(e))};return{isDown:e=>o.isDown(e)||l.has(e),bindButton:(e,a)=>{const p=g=>{g.preventDefault(),t(a,!0)},m=g=>{g.preventDefault(),t(a,!1)};return e.addEventListener("pointerdown",p,{passive:!1}),e.addEventListener("pointerup",m,{passive:!1}),e.addEventListener("pointercancel",m,{passive:!1}),e.addEventListener("pointerleave",m,{passive:!1}),()=>{e.removeEventListener("pointerdown",p),e.removeEventListener("pointerup",m),e.removeEventListener("pointercancel",m),e.removeEventListener("pointerleave",m),t(a,!1)}},press:e=>t(e,!0),release:e=>t(e,!1),dispose:()=>{o.dispose(),l.clear()}}}let K=!1;function J(){if(K)return;K=!0;const o=document.createElement("style");o.textContent=`
    .mobile-controls {
      position: fixed;
      inset: 0;
      pointer-events: none;
