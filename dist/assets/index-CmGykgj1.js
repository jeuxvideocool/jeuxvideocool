import{g as i,w as a}from"./loaders-BqXlQhzP.js";const t=document.getElementById("app"),r=i(),c=a("/apps/hub_de_jeux/"),n=a("/apps/profil/"),l=r.games.slice().sort((s,e)=>(s.order??0)-(e.order??0)).slice(0,3);t.innerHTML=`
  <div class="shell">
    <header class="hero">
