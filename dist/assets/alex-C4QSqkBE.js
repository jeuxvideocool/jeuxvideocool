import{w as u,g as S,c as k,A as f}from"./index-DwxW-jkP.js";import{getAuthState as R,subscribe as C}from"./cloud-DZuKi3HD.js";const $=document.getElementById("app"),A=u("/apps/auth/");let l=R();const w=t=>t[Math.floor(Math.random()*t.length)];function T(){$.innerHTML=`
    <div class="page">
      <main class="shell">
        <header class="hero">
