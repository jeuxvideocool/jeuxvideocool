import{a as f,g as $,w as y}from"./loaders-Bj0CnEmo.js";import{g as E,u as I,d as B,e as k,b as S,i as h}from"./index-CclJQuS1.js";import{g as L,c as u,s as P,l as w}from"./cloud-B4CuE7-U.js";const x=document.getElementById("app");function l(){const t=E(),c=f().achievements,d=new Set(t.save.achievementsUnlocked),r=$(),s=L();x.innerHTML=`
    <div class="shell">
      <header class="hero">
        <div>
        ...
        <div class="actions">
          <a class="btn ghost" href="${y("/apps/home/")}">Accueil</a>
          <a class="btn primary" href="${y("/")}">Hub de jeux</a>
        </div>
      </header>
  ...
  `,A()}function A(){var d,r,s,i,m,v,p,g,b;const t=document.getElementById("name"),c=document.getElementById("avatar");(d=document.getElementById("save-profile"))==null||d.addEventListener("click",()=>{I(e=>{e.playerProfile.name=((t==null?void 0:t.value)||"Joueur").slice(0,18),e.playerProfile.avatar=((c==null?void 0:c.value)||"🎮").slice(0,4)}),B({type:"PROFILE_UPDATED"}),l()}),(r=document.getElementById("export"))==null||r.addEventListener("click",()=>{const e=k(),n=new Blob([e],{type:"application/json"}),a=URL.createObjectURL(n),o=document.createElement("a");o.href=a,o.download="arcade-galaxy-save.json",o.click(),URL.revokeObjectURL(a)}),(s=document.getElementById("reset"))==null||s.addEventListener("click",()=>{S(),l()}),(i=document.getElementById("import-btn"))==null||i.addEventListener("click",()=>{var a;const e=((a=document.getElementById("import"))==null?void 0:a.value)||"",n=h(e);n.success?l():alert(n.error||"Import impossible")}),(m=document.getElementById("cloud-login"))==null||m.addEventListener("click",async()=>{var a,o;const e=((a=document.getElementById("cloud-email"))==null?void 0:a.value)||"",n=((o=document.getElementById("cloud-password"))==null?void 0:o.value)||"";await u("login",{email:e,password:n}),l()}),(v=document.getElementById("cloud-register"))==null||v.addEventListener("click",async()=>{var a,o;const e=((a=document.getElementById("cloud-email"))==null?void 0:a.value)||"",n=((o=document.getElementById("cloud-password"))==null?void 0:o.value)||"";await u("register",{email:e,password:n}),l()}),(p=document.getElementById("cloud-logout"))==null||p.addEventListener("click",async()=>{await u("logout"),l()}),(g=document.getElementById("cloud-save"))==null||g.addEventListener("click",async()=>{const e=E();await P(e.save)&&alert("Sauvegarde envoyée dans le cloud.")}),(b=document.getElementById("cloud-load"))==null||b.addEventListener("click",async()=>{const e=await w();e!=null&&e.state?(h(JSON.stringify(e.state)),alert("Sauvegarde cloud importée."),l()):e!=null&&e.error&&alert(e.error)})}l();
